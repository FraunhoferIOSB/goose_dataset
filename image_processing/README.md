...
The baseline checkpoint can be downloaded [here](https://bwsyncandshare.kit.edu/s/ttaTAjTmL7k9kLo/download/challenge_ppliteseg.pth). It uses the Supergradients' PPLiteSeg _PP_LITE_B_SEG75_ model.
